...
void TIM6_Configuration(void)
{
    ...
    tim.TIM_Period = 3000;  //3ms,1000Hz
    TIM_TimeBaseInit(TIM6,&tim);
    if(STATE.Check) printf("TIM6_Configuration\r\n");
}
...
{  
    ...
    TIM_ClearFlag(TIM6, TIM_FLAG_Update);
    if (STATE.Check) printf("TIM6_Start\r\n");	
}
void TIM6_Stop(void)
{
    ...
    TIM_ClearFlag(TIM6, TIM_FLAG_Update);
    if (STATE.Check) printf("TIM6_Stop\r\n");	
}
/**************************************************************************************
LED闪烁任务
**************************************************************************************/
void TIM2_Configuration(void)
{
    ...
    TIM_Cmd(TIM2,ENABLE);
    if(STATE.Check) printf("TIM2_Configuration\r\n");	
}   
